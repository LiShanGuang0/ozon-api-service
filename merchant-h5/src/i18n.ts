...
const dictionaries: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    appActivationLogin: 'Device Activation',
    ...
    appLoginDesc: 'Android App access requires shop credentials and a device activation code.',
    ...
    activateAndEnter: 'Activate and Enter',
    deviceId: 'Device ID',
    enterCockpit: 'Enter Cockpit',
    loginNote: 'Api-Key is stored only in this browser session for validation and Ozon API requests.',
    appLoginNote: 'The App binds by device ID first. MAC address is only optional auxiliary data.',
    credentialRequired: 'Please enter Client-Id and Api-Key',
    activationRequired: 'Please enter Client-Id, Api-Key, and activation code',
    deviceIdMissing: 'Device ID was not detected. Restart the App and try again.',
    activationPassed: 'Device activated',
  ...
  ru: {
    ...
    appActivationLogin: 'Активация устройства',
    ...
    appLoginDesc: 'Для Android App нужны ключи магазина и код активации устройства.',
    clientIdPlaceholder: 'Введите Ozon Client-Id',
    apiKeyPlaceholder: 'Введите Ozon Api-Key',
    activationCode: 'Код активации',
    activationCodePlaceholder: 'Введите код активации устройства',
    activateAndEnter: 'Активировать и войти',
    ...
    appLoginNote: 'App привязывается по ID устройства. MAC используется только как дополнительное поле.',
    credentialRequired: 'Введите Client-Id и Api-Key',
    activationRequired: 'Введите Client-Id, Api-Key и код активации',
    deviceIdMissing: 'ID устройства не получен. Перезапустите App и попробуйте снова.',
    activationPassed: 'Устройство активировано',
